...
import { Path, useForm, FieldValues, DefaultValues, SubmitHandler } from 'react-hook-form';
...
const AuthForm = <T extends FieldValues>({ schema, onSubmit, formType }: AuthFormProps<T>) => {
